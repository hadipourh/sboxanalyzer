...
bool taut_special_cases(pcube *T) /* T will be disposed if answer is determined */
{
...
static bool ftaut_special_cases(pcube *T, sm_matrix *table) /* T will be disposed if answer is determined */
{
